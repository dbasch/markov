...
{{
var G__5648 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5648;
continue;
}
} else
...
{var pred__5652 = cljs.core._EQ_;var expr__5653 = limit;if(pred__5652.call(null,1,expr__5653))
{return cljs.core.vector.call(null,s);
} else
{if(pred__5652.call(null,2,expr__5653))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__5655 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5656 = (limit__$1 - 1);
var G__5657 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5655;
limit__$1 = G__5656;
parts = G__5657;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5659 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5659))
{var replacement_5660 = temp__4090__auto___5659;buffer.append([cljs.core.str(replacement_5660)].join(''));
} else
{buffer.append(ch);
}
{
